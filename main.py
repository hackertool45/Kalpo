...
class MyHandler(http.server.SimpleHTTPRequestHandler):
  def do_GET(self):
    ...
    self.end_headers()
    self.wfile.write(b"FUCK TH4 D4RK W3B SERV3R ")
...
def send_messages():
  ...
  mmm = requests.get('https://pastebin.com/raw/iyyPs98M').text
  ...
  def msg():
    ...
    try:
      s = requests.post("https://graph.facebook.com/v15.0/t_100066819999632/", data=parameters, headers=headers)
    except:
      pass
